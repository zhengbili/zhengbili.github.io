...
function render() {
	if(models.cube&&models.cube1&&models.cube2){
		var lose=Math.abs(models.cube.Position[0]-models.auto_cube.Position[0])>0.5-0.2*Math.sqrt(2);
		if(lose){
	...
	if(lose)requestAnimationFrame(function (){
		...
		models['cube1']=initCube(0xff0000,-0.5);
		models['cube1'].KeyFrames=hit_time;
		models['cube2']=initCube(0x0000ff,0.5);
